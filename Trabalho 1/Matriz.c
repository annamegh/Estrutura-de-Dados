...
int carrega_arquivo( char *nome, Matriz *p, int l, int c) {
...
int soma_matrizes( Matriz m1, Matriz m2, Matriz *p) {
    if( m1.lin != m2.lin || m1.col != m2.col)
        return MATRIZES_INCOMPATIVEIS; //se testar o erro, já sai
